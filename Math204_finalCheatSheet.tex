...
Set $Z_i = 0$ for one result (reference group) and $Z_i = 1$ for the other. 
$$Y_i = \beta_0 + \beta_1 z_i + \beta_2z_2 + \epsilon_i$$
Where $\hat{\beta}_0 = \bar{Y}_0$, $\hat{\beta}_1 = \bar{Y}_1 -\bar{Y}_0$, and $\hat{\beta}_2 = \bar{Y}_2- \bar{Y}_1$.
The null hypothesis would be $\mathcal{H}_0 : \beta_1 = 0 \iff \mathcal{H}_0 :\mu_1 = \mu_0$
